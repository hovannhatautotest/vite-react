...
User look menu "${text}"
    Element Text Should Be
    ...    xpath=//li[contains(@class, "menu") and descendant::span[contains(text(), "${text}")]]
    ...    ${text}
...
Show list of users
    ...
    FOR    ${item}    IN    @{elements}
        ...
        Log To Console
        ...    ${stt}. ${username} | ${position} | ${role} | ${manager} | ${team} | ${Email} | ${phone_number} | ${start_date}
        Log To Console
        ...    =====================================================================================================================================================
...
No users are shown
    ...
    IF    '${text}' == 'Trống'
        Log To Console    Không có User nào ứng với từ khóa tìm khiếm
    END
